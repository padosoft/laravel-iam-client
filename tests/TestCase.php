...
{
    /**
     * The client is tested together with the server package (its in-process PDP,
     * Grant/Permission models and migrations), resolved from Packagist as a dev dependency.
     *
